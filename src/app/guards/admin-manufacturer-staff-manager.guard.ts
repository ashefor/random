...
export class AdminManufacturerStaffManagerGuard implements CanActivate {
  ...
  canActivate() {
    ...
    if (this.userGroup !== null && this.userGroup !== undefined) {
      ...
      if (this.userGroup === 'admin' || this.userGroup === 'manufacturer_staff' || this.userGroup === 'manager') {
        return true;
      } else {
        return false;
      }
